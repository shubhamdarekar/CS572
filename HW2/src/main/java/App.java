...
public class App {
    ...
    private static void fetchCSV() throws Exception {
        ...
        File newFile = new File("fetch_nytimes.csv");
        newFile.delete();
    ...
    private static void visitCSV() throws Exception {
        File newFile = new File("visit_nytimes.csv");
        newFile.delete();
        newFile.createNewFile();
        BufferedWriter bw = new BufferedWriter(new FileWriter(newFile, true));
    ...
    private static void urlCSV() throws Exception {
        File newFile = new File("urls_nytimes.csv");
        newFile.delete();
        newFile.createNewFile();
        BufferedWriter bw = new BufferedWriter(new FileWriter(newFile, true));
    ...
    private static void report() throws Exception {
        ...
        newFile.createNewFile();
        BufferedWriter bw = new BufferedWriter(new FileWriter(newFile, true));
        bw.write("Name: Shubham S Darekar\n");
        bw.write("USC ID: 1641138809\n");
